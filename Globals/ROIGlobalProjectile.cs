...
namespace ROI.Globals
{
    ...
    /// </summary>
    class ROIGlobalProjectile : GlobalProjectile
    {
        ...
        public void DeathRayAIStyle(Projectile projectile)
        {
            ...
            if (TBDLater2(projectile)) return;
        ...
        private static bool TBDLater2(Projectile projectile)
        {
            switch (projectile.type)
            {
