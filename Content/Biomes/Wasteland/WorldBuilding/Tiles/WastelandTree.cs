/* 
using InfinityCore.ROI.API.Interface;
...
namespace ROI.Tiles.Wasteland
{
    ...
    public class WastelandTree : ModTree, ITreeHook
    {
        ...
        public override Texture2D GetBranchTextures(int i, int j, int trunkOffset, ref int frame) =>
            ModContent.GetTexture("ROI/Assets/Textures/Tree/Wasteland_Tree_Branch");

        public override Texture2D GetTexture() =>
            ModContent.GetTexture("ROI/Assets/Textures/Tree/Wasteland_Tree");

        public override Texture2D GetTopTextures(int i, int j, ref int frame, ref int frameWidth, ref int frameHeight, ref int xOffsetLeft, ref int yOffset) =>
            ModContent.GetTexture("ROI/Assets/Textures/Tree/Wasteland_Tree_Top");
        ...
        public void PostDrawTreeTop(SpriteBatch sb, Vector2 position, Rectangle? sourceRectangle, Vector2 origin)
        {
            ...
            var tex = ModContent.GetTexture("ROI/Assets/Textures/Tree/Wasteland_Tree_Top_Glowmask");
        ...
        {
            var tex = ModContent.GetTexture("ROI/Assets/Textures/Tree/Wasteland_Tree_Branch");
