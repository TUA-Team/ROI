...
{
    public class WastebrickChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            ContainerName.SetDefault("Wastebrick Chest");

            ModTranslation name = CreateMapEntryName();
            name.SetDefault("Wastebrick Chest");
            AddMapEntry(new Color(48, 44, 65), name, MapChestName);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.WastebrickChest>();
