...
namespace ROI.Content.NPCs.Bosses.VoidPillar
{
    public sealed partial class VoidPillar
    {
        ...
        private static readonly Texture2D RING_TEXTURE = (Texture2D)ModContent.GetTexture("ROI/Assets/Textures/NPCs/VoidRing");
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            if (MovementAIPhase == 2f)
            {
                ...
                for (int k = (npc.oldPos.Length / 3); k < npc.oldPos.Length; k++)
                {
                    ...
                    Color color = npc.GetAlpha(drawColor) * ((npc.oldPos.Length - k) / (2f * npc.oldPos.Length));
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            DrawData drawingData = new DrawData((Texture2D)Main.Assets.Request<Texture2D>("Images/Misc/Perlin"),
