    ...
    public sealed partial class VoidPillar
    {
        ...
        private void TeleportationPhase()
        {
            ...
            if (_teleportationTimer <= 0 && _teleportationRingScale < 0f)
            {
                ...
                if (ModContent.TryFind<ModProjectile>("VoidTeleportationShockwave", out var proj))
                    Projectile.NewProjectile(npc.Center, Vector2.Zero, proj.Type, 100, 1f, Main.myPlayer);
