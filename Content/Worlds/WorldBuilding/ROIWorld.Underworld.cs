...
namespace ROI.Content.Worlds
{
    ...
    partial class ROIWorld : ModWorld
    {
        ...
        {
            progress.Message = Language.GetTextValue("LegacyWorldGen.36");
                ...
                while (!flag17)
                {
                    ...
                    try
                    {
                        if (Main.tile[num260, num261].wall == 13 || Main.tile[num260, num261].wall == 14)
                        {
                            ...
                            num261--;
                            WorldGen.PlaceTile(num260, num261, 77);
                    ...
                    {
                        ROIMod.Instance.Logger.Error("Error during underworld generation", e);
                    }
                }
            }
        }
