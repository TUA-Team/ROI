...
namespace ROI.Projectiles
{
    ...
    /// </summary>
    class Wasteland_Bubble : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.projectile.Any(i => i.Hitbox.Intersects(projectile.Hitbox) && i.type != projectile.type && i.type != ModContent.ProjectileType<Wasteland_Surface_Bubble>()))
            {
