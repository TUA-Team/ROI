...
{
	// https://github.com/tModLoader/tModLoader/blob/master/ExampleMod/Projectiles/ExampleExplosive.cs
	public class WastelandBomb : ModProjectile
	{
		...
		public override string Texture => "ROI/Items/Weapons/Wasteland/WastelandBomb";
