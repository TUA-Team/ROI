...
namespace ROI.Helpers
{
    internal static class GeneralWorldHelper
    {
        ...
        public static void RegularMerge(int i, int j)
        {
            ...
            //WorldGen.TileMergeAttempt(Type, ModContent.TileType<Wasteland_Dirt"), ref up, ref down, ref left, ref right, ref upLeft, ref upRight, ref downLeft, ref downRight);
