...
{
    class Irradiated_Chest : ModTile
    {
        public override void SetDefaults()
        {
            ...
            chestDrop = mod.ItemType("Irradiated_Chest");
        }
        ...
        public override void RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    int key = mod.ItemType("IrradiatedKey");
                    if (player.HeldItem.type == key && Chest.Unlock(left, top))
                    {
                        if (Main.netMode == 1)
                        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.showItemIcon2 = mod.ItemType("Irradiated_Chest");
                    if (Main.tile[left, top].frameX / 36 == 1)
                        player.showItemIcon2 = mod.ItemType("IrradiatedKey");
